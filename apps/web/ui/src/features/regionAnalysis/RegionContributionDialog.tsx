...
export default function RegionContributionDialog({
  ...
  const payload = useMemo<JobRequest>(() => {
    ...
    return {
      ...
      language,
      selection: sel,
      analysis: { type: "region_contrib", impacts: [impactKey], params: { region_exiobase: regionExiobase, top_n: 30 } },
    };
  }, [impactKey, language, regionExiobase, selection, year]);
