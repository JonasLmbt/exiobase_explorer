...
type ContribTableV1 = {
  ...
  meta?: { unit?: string; region?: string; region_exiobase?: string; impact_key?: string; impact_resolved?: string };
...
export default function RegionContributionDialog({
  open,
  onClose,
  impactKeys,
  initialImpactKey,
  ...
  const payload = useMemo<JobRequest>(() => {
    ...
    return {
      ...
      language,
      selection: sel,
      analysis: { type: "region_contrib", impacts: [activeImpact], params: { region_exiobase: regionExiobase, top_n: 30 } },
    };
  }, [activeImpact, language, regionExiobase, selection, year]);
  ...
  }, [open, activeImpact, regionExiobase]);
